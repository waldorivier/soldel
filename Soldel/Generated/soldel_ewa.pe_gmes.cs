...
namespace mupeModel
{
    ...
    /// <summary>
    /// There are no comments for pe_gmes, Soldel in the schema.
    /// </summary>
    public partial class pe_gmes : INotifyPropertyChanging, INotifyPropertyChanged {

        private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(System.String.Empty);

        private string _pe_grmu_id;

        private string _pe_este_id;
        ...
        {
          pe_gmes toCompare = obj as pe_gmes;
          if (toCompare == null)
          {
            return false;
          }
          ...
          if (!Object.Equals(this.pe_grmu_id, toCompare.pe_grmu_id))
            return false;
          if (!Object.Equals(this.pe_este_id, toCompare.pe_este_id))
            return false;
        ...
        public override int GetHashCode()
        {
          ...
          hashCode = (hashCode * 7) + pe_este_id.GetHashCode();
          return hashCode;
        }
        ...
        /// <summary>
        /// There are no comments for pe_este_id in the schema.
        /// </summary>
        public virtual string pe_este_id
        {
            get
            {
                return this._pe_este_id;
            }
            set
            {
